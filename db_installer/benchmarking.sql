...
CREATE TABLE `bench` (
  ...
  `comments` text,
  `inc_des` smallint(6) DEFAULT NULL,
  `inc_quart` smallint(6) DEFAULT NULL,
  `inc_kernel` smallint(6) DEFAULT NULL,
  ...
  `export_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ben_id`)
...
CREATE TABLE `cell_data` (
  ...
  KEY `col_id` (`col_id`),
  KEY `row_id` (`row_id`),
  CONSTRAINT `cell_data_ibfk_1` FOREIGN KEY (`col_id`) REFERENCES `col_head` (`col_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cell_data_ibfk_2` FOREIGN KEY (`row_id`) REFERENCES `row_head` (`row_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `col_head` (
  ...
  PRIMARY KEY (`col_id`),
  KEY `col_head_ibfk_1` (`ben_id`),
  CONSTRAINT `col_head_ibfk_1` FOREIGN KEY (`ben_id`) REFERENCES `bench` (`ben_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `row_head`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `row_head` (
  `row_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ben_id` bigint(20) DEFAULT NULL,
  `row_code` varchar(255) NOT NULL,
  `is_ref` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`row_id`),
  KEY `row_head_ibfk_1` (`ben_id`),
  CONSTRAINT `row_head_ibfk_1` FOREIGN KEY (`ben_id`) REFERENCES `bench` (`ben_id`) ON DELETE CASCADE ON UPDATE CASCADE
