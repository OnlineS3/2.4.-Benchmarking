...
var exportSvg2PNG = function(args) {
    ...
    var container = (args.container) ? '#' + args.container : '#export-svg2';
 ...
 * @param {string} filename  
 */
function svg2img(container) {
    
    var cont = (container) ? '#'+ container : '#export-svg';
    try {
        // svg object to string
        var svg = d3.select('#export-svg').node();
